...
public class Player : Entity
{
    ...
    protected override void Update()
    {
        ...
        else
        {
            if (dead && !reallyDead)
            {
                ...
                dead = false;
                GetComponent<PlayerController>().movementEnabled = true;
                GetComponent<PlayerController>().combatEnabled = true;
        ...
        if (!dead)
        {
            if (GetComponent<PlayerController>().combatEnabled && !GameManager.instance.skillsManager.CheckEmpty())
            {
    ...
    public void nextSphere()
    {
        ...
        if (!GameManager.instance.skillsManager.CheckEmpty())
        {
    ...
    public override void die()
    {
        ...
        GetComponent<PlayerController>().combatEnabled = false;
